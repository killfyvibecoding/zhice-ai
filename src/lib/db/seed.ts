...
function loadAvatarBase64(): string {
  const imgPath = path.resolve(process.cwd(), 'images/starter-avatar.jpg');
  if (!fs.existsSync(imgPath)) {
    console.warn('Warning: images/starter-avatar.jpg not found, skipping avatar');
    return '';
  }
...
async function seed() {
        ...
        items: [
          {
            ...
            endDate: null,
            current: true,
            description: '负责企业协作平台的前端架构设计与核心功能开发。',
            highlights: [
          ...
          },
          {
            ...
            endDate: '2022-02',
            current: false,
            description: '参与数据服务平台的开发与维护，负责前端工程效率建设。',
            highlights: [
          ...
          },
          {
            ...
            endDate: '2019-06',
            current: false,
            description: '参与本地生活商家端 B 端系统的前端开发。',
            highlights: [
      ...
      content: {
        items: [
          ...
          },
          {
            id: crypto.randomUUID(),
            name: '澄明组件库',
            url: 'https://zhice.ai/portfolio/components',
            startDate: '2023-03',
            endDate: '',
  ...
  console.log('Seed complete! Starter resume created for user "陈思远"');
  process.exit(0);
}
